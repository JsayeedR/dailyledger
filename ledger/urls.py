...
urlpatterns = [
    ...
    path('loans/repay/', views.add_loan_repayment, name='add_loan_repayment'),
    path('loans/repayments/<uuid:pk>/delete/', views.delete_loan_repayment, name='delete_loan_repayment'),
